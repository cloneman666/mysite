					...
					<table cellspacing="2" cellpadding="0" width="98%" align="center" border="0">
						<tbody>
							...
							<tr>
								...
								<td>
									<input class="text" id="title" title="请输入文章的标题" size="20" name="title">
								</td>
							</tr>
							<tr>
                              ...
                              <textarea name="miaoshu" cols="50" rows="5" id="miaoshu"></textarea></td>
							</tr>
							<tr>
							</tr>
							<tr>
